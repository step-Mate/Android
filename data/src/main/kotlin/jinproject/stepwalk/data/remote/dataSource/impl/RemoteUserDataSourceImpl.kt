...
internal class RemoteUserDataSourceImpl @Inject constructor(
    ...
    override suspend fun selectDesignation(designationRequest: DesignationRequest){
        suspendAndCatchStepMateData(retrofit){
            userApi.selectDesignation(designationRequest)
        }
    }

    override suspend fun getDesignations(): DesignationState =
        userApi.getDesignations().toDesignationModel()
